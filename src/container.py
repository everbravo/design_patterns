...
from src.strategies.pricing_strategy import StandardPricingStrategy
...
class Container:
    ...
    def _setup_dependencies(self):
        ...
        # Add observers to cart service
        self._instances['cart_service'].add_observer(InventoryObserver())
        self._instances['cart_service'].add_observer(AnalyticsObserver())
        ...
        self._instances['cart_controller_args'] = (self._instances['cart_service'], self._instances['auth_service'])
